...
export class Board {
  ...
  private addKnigt() {
    new Knignt(Colors.BLACK, this.getCell(1, 0));
    new Knignt(Colors.BLACK, this.getCell(6, 0));
    new Knignt(Colors.WHITE, this.getCell(1, 7));
    new Knignt(Colors.WHITE, this.getCell(6, 7));
  }
  public addFigure() {
    this.addPawns();
    this.addQueen();
